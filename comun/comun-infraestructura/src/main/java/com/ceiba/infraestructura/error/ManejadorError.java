...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        ...
        CODIGOS_ESTADO.put(ExcepcionCantidad.class.getSimpleName(),HttpStatus.INTERNAL_SERVER_ERROR.value());
        CODIGOS_ESTADO.put(ExcepcionDisponibilidad.class.getSimpleName(),HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(ExcepcionExistencia.class.getSimpleName(),HttpStatus.NOT_FOUND.value());
        CODIGOS_ESTADO.put(ExcepcionExistenciaBoleto.class.getSimpleName(),HttpStatus.NOT_FOUND.value());
        CODIGOS_ESTADO.put(ExcepcionLongitudValor.class.getSimpleName(),HttpStatus.INTERNAL_SERVER_ERROR.value());
        CODIGOS_ESTADO.put(ExcepcionProyeccionTiempo.class.getSimpleName(),HttpStatus.INTERNAL_SERVER_ERROR.value());
        CODIGOS_ESTADO.put(ExcepcionSinDatos.class.getSimpleName(),HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(ExcepcionTiempoDeCambio.class.getSimpleName(),HttpStatus.INTERNAL_SERVER_ERROR.value());
        CODIGOS_ESTADO.put(ExcepcionValorInvalido.class.getSimpleName(),HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(ExcepcionValorObligatorio.class.getSimpleName(),HttpStatus.BAD_REQUEST.value());
