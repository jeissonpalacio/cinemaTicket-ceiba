...
insert into movie_projector(date_movie_projector,hour_movie_projector,id_movie,id_cinema) VALUES (TO_DATE('05-09-2022','dd-MM-yyyy'),PARSEDATETIME('12:30', 'HH:MM'),1,1);
insert into movie_projector(date_movie_projector,hour_movie_projector,id_movie,id_cinema) VALUES (TO_DATE('29-09-2022','dd-MM-yyyy'),PARSEDATETIME('06:30', 'HH:MM'),1,1);
