...
import com.ceiba.dominio.excepcion.ExcepcionCantidad;
...
public class Boleto {
    ...
    public Boleto(Integer idClient, Double amount, Integer idMovieProjector){
    ...
    public Boleto(Integer idClient, Double amount, Integer idMovieProjector, List<Integer> idSeats){
    ...
    public Boleto(Long idTicket, Integer idClient, Double amount, Integer idMovieProjector, List<Integer> idSeats) {
        validatePrice(amount);
        validarCantidad(idSeats);
        validarObligatorio(idClient,SE_DEBE_INGRESAR_ID_DEL_CLIENT);
        validarObligatorio(amount,SE_DEBE_TENER_UN_MONTO);
